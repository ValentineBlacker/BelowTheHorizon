...
class Label(pygame.sprite.DirtySprite):    
    ...
    def __init__(self, scene, size = (500,100), location = (400,250), 
                 font_size = 50, font_name = prepare.FONT):
        ...
        self.textcolor = (pygame.color.Color("white"))
        self.backgroundcolor = (pygame.color.Color("black"))     
        self.highlightcolor = (pygame.color.Color("yellow"))
